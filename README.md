...
Ai-get 是一个 **AI B2B 销售智能体平台**的全栈复刻实践项目：从目标客户挖掘、企业背调、智能体训练，到多渠道触达与商机洞察，串起一条完整的智能获客链路。

> 本项目是对 [revor.ai](https://revor.ai) 的界面与交互复刻，用于前后端工程实践，与 revor.ai 官方无任何关联，页面文案中的品牌名与销售智能体名（REVOR）均沿用参考站。

![营销首页](screenshots/home.png)
